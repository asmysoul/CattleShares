	...
	<body>
		<div class="content-left">
			...
			<div class="search-top">
				账号ID：<input class="usermessage" type="" name="" id="rrdUserid" value="" /> 昵称：
				<input class="usermessage" type="" name="" id="rrdUsername" value="" />
				状态：<select class="member-select select" id="rrdState">
		...
		<script src="${pageContext.request.contextPath}/resource/js/ReflectRecode.js"></script>
